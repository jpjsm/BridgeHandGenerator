...
namespace BridgeHandGenerator_UnitTests.hand
{
    public class UnitTests_Hand
    {
        ...
        public void TestConstructor()
        {
            ...
            ClassicAssert.AreEqual(expected_HCP, actual.HCP_INITIAL);
            ClassicAssert.AreEqual(expected_HCP, actual.Count_Points());
            ClassicAssert.AreEqual(expected_Compact_hand, actual.Compact_hand);
            ClassicAssert.AreEqual(expected_cards, actual.Get_Cards);
            ClassicAssert.AreEqual(expected_Compact_hand.ToString(), actual.Serialize());
            ClassicAssert.AreEqual(expected_ToString, actual.ToString());
            ClassicAssert.AreEqual(Hand.Deserialize(actual.Serialize()), actual);
            ClassicAssert.AreEqual(Hand.Deserialize(expected_Compact_hand.ToString()), actual);
        }
        ...
        public void TestConstructorExceptions()
        {
            ...
            ClassicAssert.Throws<ApplicationException>(() => new Hand(empty_hand));
            #pragma warning disable CS8604
            ClassicAssert.Throws<ApplicationException>(() => new Hand(null_hand));
            #pragma warning restore CS8604
            ClassicAssert.Throws<ApplicationException>(() => new Hand(one_too_many_hand));
            ClassicAssert.Throws<ApplicationException>(() => new Hand(repeated_values_do_not_count));
        ...
        public void TestCompact_Hand()
        {
            ...
            {
                ClassicAssert.AreEqual(value.expected, (new Hand(value.actual)).Compact_hand);
            }
        }
        ...
        public void TestShow_Hand()
        {
            ...
            ClassicAssert.AreEqual(expected_cards, actual_cards);
            ClassicAssert.That(hand.HandInPlay, Is.False);
            ClassicAssert.That(hand.Get_Cards.Count, Is.EqualTo(0));
        }
        ...
        public void TestHandInPlay()
        {
            ...
            ClassicAssert.AreEqual(expected_HandInPlay_before_end_of_game, actual.HandInPlay);
            var _anycard = actual.Play(Cards.Spades_Ace);
            ClassicAssert.AreEqual(expected_HandInPlay_before_end_of_game, actual.HandInPlay);
            var _anyhand = actual.Show_Hand;
            ClassicAssert.AreEqual(expected_HandInPlay_after_end_of_game, actual.HandInPlay);
        }
        ...
        public void TestGet_Cards()
        {
            ...
            while (expected_cards.Count > 0)
            {
                ...
                ClassicAssert.AreEqual(expected_card, actual_card);
            }
        }
        ...
        public void TestPlay()
        {
            ...
            ClassicAssert.Throws<ApplicationException>(() => hand.Play(actual_card));
        }
        ...
        public void TestCount_Points()
        {
            ...
            ClassicAssert.AreEqual(expected_HCP, hand.Count_Points());
        ...
        public void TestSerialize()
        {
            ...
            {
                ClassicAssert.AreEqual(expected.ToString(), (new Hand(actual)).Serialize());
            }
        }
        ...
        public void TestDeserialize()
        {
            ...
            {
                ClassicAssert.AreEqual(new Hand(expected), Hand.Deserialize(actual.ToString()));
            }
        }
        ...
        public void TestEquals()
        {
            ...
            {
                ClassicAssert.IsTrue(expected.Equals(new Hand(cards)));
            }

            ClassicAssert.IsFalse(expected.Equals(null));
            
            ClassicAssert.IsFalse(expected.Equals(hands[0]));

            Hand all_clubs = Hand.Deserialize(0b1111111111111.ToString());
            ClassicAssert.IsFalse(expected.Equals(all_clubs));
        }
        ...
        public void TestGetHashCode()
        {
            ...
            for (int i = 0; i < upper.Length; i++)
            {
                ...
                ClassicAssert.AreEqual(expected, hand.GetHashCode());
            }
        }
        ...
        public void TestToString()
        {
            ...
            for (int i = 0; i < compact_hands.Length; i++)
            {
                ...
                ClassicAssert.AreEqual(expected_hands[i], actual);
            }
